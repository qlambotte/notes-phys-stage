...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, left=2mm, leftrule=.75mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomrule=.15mm, breakable, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, left=2mm, leftrule=.75mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame, arc=.35mm, bottomrule=.15mm, breakable, opacityback=0]
\begin{minipage}[t]{5.5mm}
