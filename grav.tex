...
{\centering \includegraphics[width=0.7\textwidth,height=\textheight]{figures/grav/mars-2.pdf}
...
{\centering \includegraphics[width=0.4\textwidth,height=\textheight]{figures/grav/soleil.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, breakable, colback=white, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, opacityback=0]
...
{\centering \includegraphics[width=0.6\textwidth,height=\textheight]{figures/grav/fig1.pdf}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{figures/grav/aires.pdf}
...
{\centering \includegraphics[width=0.3\textwidth,height=\textheight]{figures/grav/fig3.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, breakable, colback=white, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, left=2mm, opacityback=0]
\begin{minipage}[t]{5.5mm}
...
{\centering \includegraphics[width=0.4\textwidth,height=\textheight]{figures/grav/fig4.pdf}
...
\[
k_g = 6,67 \cdot 10^{-11} \dfrac{\text{N} \cdot \text{m}^2}{\text{kg}^2}.
\]
...
{\centering \includegraphics[width=0.4\textwidth,height=\textheight]{figures/grav/fig02.pdf}
...
\(6,67 \cdot 10^{-11} \frac{\text{N} \cdot \text{m}^2}{\text{kg}^2}\) \\
Accélération terrestre \(g\) & \(9,81 \text{ m/s}^2\) \\
Masse de la Terre \(m_T\) & \(5,97 \cdot 10^{24} \text{ kg}\) \\
Masse du Soleil \(m_S\) & \(1,99 \cdot 10^{30} \text{ kg}\) \\
\end{longtable}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{figures/grav/orbites.pdf}
...
{\centering \includegraphics[width=0.3\textwidth,height=\textheight]{figures/grav/neptune.png}
...
\end{figure}%
\subsection{Détermination de la masse des corps célestes}
...
terrestre subit une accélération \(g = 9,81\) m/s$^{2}$. Cette accélération
...
En utilisant \(g_M = 3,71\) m/s$^{2}$ et \(R_M = 3,39 \cdot 10^6\) m,
...
{\centering \includegraphics[width=0.4\textwidth,height=\textheight]{figures/grav/fig5.pdf}
...
\item
  ...
  à 400 km d'altitude.
\item
  Compare cette valeur avec \(g = 9,81\) m/s$^{2}$.
\end{enumerate}
...
{\centering \includegraphics[width=0.4\textwidth,height=\textheight]{figures/grav/fig6.pdf}
