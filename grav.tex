...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, opacityback=0, breakable, toprule=.15mm, colback=white, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, left=2mm]
\begin{minipage}[t]{5.5mm}
