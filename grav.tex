...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, breakable, left=2mm, opacityback=0, leftrule=.75mm, arc=.35mm, toprule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, breakable, left=2mm, opacityback=0, leftrule=.75mm, arc=.35mm, toprule=.15mm, colback=white]
\begin{minipage}[t]{5.5mm}
...
La station spaciale internationnale (ISS) est en orbite circulaire
autour de la Terre à une altitude de 400km. Calcule la vitesse de l'ISS.
...
\item
  elle est dans la Station Spaciale Internationnale (400km d'altitude).
\end{enumerate}
...
Pour cet object, s'il est à la surface de la Terre, nous avons
