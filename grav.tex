...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, breakable, colframe=quarto-callout-important-color-frame, opacityback=0, left=2mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, leftrule=.75mm]
\begin{minipage}[t]{5.5mm}
