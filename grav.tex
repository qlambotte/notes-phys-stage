...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-note-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, leftrule=.75mm, left=2mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-important-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, opacityback=0, arc=.35mm, leftrule=.75mm, left=2mm, colback=white]
\begin{minipage}[t]{5.5mm}
