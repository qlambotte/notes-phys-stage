...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, breakable, coltitle=black, opacityback=0, bottomrule=.15mm, colback=white, title={Fission nucléaire}, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
\[
 ^{235}_{92}\text{U} + ^1_0\text{n} \rightarrow ^{236}_{92}\text{U}\rightarrow ^{95}_{38}\text{Sr} + ^{139}_{54}\text{Xe} + 2 ^1_0\text{n} + 3,2 \cdot 10^{-11}\text{J}
 \]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, breakable, coltitle=black, opacityback=0, bottomrule=.15mm, colback=white, title={Fusion nucléaire}, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
Les réactions nucléaires au coeur du Soleil sont complexes et variées,
