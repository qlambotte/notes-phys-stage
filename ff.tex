...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, left=2mm, coltitle=black, toptitle=1mm, title={Fission nucléaire}, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm, colback=white, titlerule=0mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, left=2mm, coltitle=black, toptitle=1mm, title={Fusion nucléaire}, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm, colback=white, titlerule=0mm, toprule=.15mm]
